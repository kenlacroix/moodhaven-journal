...
import { CloudSyncChip } from '../sync/CloudSyncChip';

export type ViewType = 'writing' | 'timeline' | 'onthisday' | 'insights' | 'calendar' | 'analytics' | 'settings';
...
export function Sidebar({ currentView, onNavigate }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Sync status footer — only when WebDAV is configured */}
