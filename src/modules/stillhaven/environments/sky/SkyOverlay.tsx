/**
 * SkyOverlay — 2.5s transition into the sky environment.
 * Mirrors the SubmergeOverlay phase timeline with deep-blue/violet colours.
...
export function SkyOverlay({ onComplete }: Props): React.JSX.Element | null {
    ...
    <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 50 }} aria-hidden>
      ...
      {!REDUCED_MOTION && (
        <div
          ...
          style={{
            height: `${risePercent}%`,
            background: 'linear-gradient(to top, #080B1A 40%, #2A1B5E 75%, #5B3B9E 100%)',
            opacity: phase === 'fading' ? 0 : 1,
