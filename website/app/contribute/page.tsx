export default function ContributePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-gray-800 space-y-10">
      <h1 className="text-3xl font-bold text-primary-700 text-center">Contribute to MoodHaven</h1>
      ...
      <div className="space-y-6">
        <div>
          <h2 className="font-semibold text-lg text-primary-700">🧑‍💻 Developers</h2>
          <p>
        ...
        <div>
          <h2 className="font-semibold text-lg text-primary-700">✍️ Writers &amp; Testers</h2>
          <p>
        ...
        <div>
          <h2 className="font-semibold text-lg text-primary-700">📣 Advocates</h2>
          <p>
      ...
      <div className="text-center pt-8">
        <a
          href="https://github.com/kenlacroix/moodhaven-journal"
          className="inline-block bg-primary-700 text-white px-6 py-3 rounded-full hover:bg-primary-800 transition"
          target="_blank"
          rel="noopener noreferrer"
        >
          Visit the GitHub Repository &rarr;
        </a>
      </div>
    </div>
  );
