...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-gray-800 space-y-10">
      <h1 className="text-3xl font-bold text-blue-700 text-center">Terms of Use</h1>
      <p className="text-sm text-gray-400 text-center">Last updated: April 2026</p>

      <div className="space-y-8">

        <div>
          <h2 className="font-semibold text-lg text-blue-600">Use of the app</h2>
          <p>
            MoodHaven Journal (web app at <a href="https://journal.moodhaven.app" className="text-blue-600 underline">journal.moodhaven.app</a> and
        ...
        <div>
          <h2 className="font-semibold text-lg text-blue-600">Your data</h2>
          <p>
        ...
        <div>
          <h2 className="font-semibold text-lg text-blue-600">No warranty</h2>
          <p>
        ...
        <div>
          <h2 className="font-semibold text-lg text-blue-600">Open source</h2>
          <p>
        ...
        <div>
          <h2 className="font-semibold text-lg text-blue-600">Changes</h2>
          <p>
