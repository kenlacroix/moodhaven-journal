...
v1.1 planning is underway. The immediate focus is **StillHaven** — a somatic companion module to help you settle before you write. Separate from the journal, intentionally calm, built with the same privacy constraints as everything else.
